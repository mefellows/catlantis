(ns yimp.android.scenes.root
  (:require [reagent.core :as r]
            [clojure.string :refer [blank?]]
            [re-frame.core :refer [subscribe dispatch dispatch-sync]]
            [yimp.android.shared.ui :as ui]
            [yimp.android.shared.scenes.main :refer [main-scene]]
            [yimp.android.shared.scenes.about :refer [about-scene]]
            [yimp.android.ui :as android-ui]
            [yimp.android.styles :as s]
            [yimp.android.components.drawer :refer [drawer-component]]))
